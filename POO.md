...
->São os métodos que só podem ser invocados a partit de um objeto, ou seja, uma classe instanciada
...
**Métodos de classe**
-> São métodos que podem ser execultados a partir da p´ropria classe, ou seja, não é necessário instanciar um objeto
